    ...
    'main': {
        ...
        'keyboard': {
            "inline_keyboard": [
                ...
                [{"text": "🌍 UBI Система", "callback_data": "ubi:show"}]
            ]
        }
    }
}

def send_menu(chat_id, menu_name='main'):
    """Отправляет или редактирует меню"""
...
def edit_menu(chat_id, message_id, menu_name='main'):
...
💫 *Продолжайте эволюцию!*"""
            ...
            elif callback_text.startswith('course:'):
                course_id = callback_text.split(':')[1]
                course_map = {
            ...
            elif callback_text == "payment:premium":
            ...
            elif callback_text == "profile:show":
                progress = USER_PROGRESS.get(chat_id, {"пройденные_уроки": [], "уровень": 1, "баллы": 0})
...
💫 *Создаем экономику изобилия вместе*"""
            ...
            elif callback_text == "menu:main":
                # Возврат к главному меню
                edit_menu(chat_id, callback_data['message']['message_id'])
